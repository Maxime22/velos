class Slider {
    ...
    init(idSlider,slider,imgs,figures) {
    ...
    createEvents() {
        ...
        this.slider.stopBtn.addEventListener("click", function (e) {
            slider.stopProgressBar(0);
        });
        
        this.slider.restartBtn.addEventListener("click", function (e) {
            slider.startProgressBar(1);
        });
        
        this.slider.next.addEventListener("click", function (e) {
            slider.changeSlide(1, 1);
        });
        
        this.slider.prev.addEventListener("click", function (e) {
            slider.changeSlide(-1, 1);
        });
